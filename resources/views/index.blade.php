  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-xs-6 work">
        <img class="img-responsive" src="{{asset('assets/img/work1.jpg')}}" alt="">
        ...
        <div class="work-content">
          ...
          <div class="work-link">
            ...
            <a class="lightbox" href="{{asset('assets/img/work1.jpg')}}"><i class="fa fa-search"></i></a>
          </div>
        </div>
      </div>
      <!-- /Work -->
      ...
      <!-- Work -->
      <div class="col-md-4 col-xs-6 work">
        <img class="img-responsive" src="{{asset('assets/img/work2.jpg')}}" alt="">
        <div class="overlay"></div>
        <div class="work-content">
          <span>Category</span>
          <h3>Lorem ipsum dolor</h3>
          <div class="work-link">
            <a href="#"><i class="fa fa-external-link"></i></a>
            <a class="lightbox" href="{{asset('assets/img/work2.jpg')}}"><i class="fa fa-search"></i></a>
          </div>
        </div>
      </div>
      <!-- /Work -->
      ...
      <!-- Work -->
      <div class="col-md-4 col-xs-6 work">
        <img class="img-responsive" src="{{asset('assets/img/work3.jpg')}}" alt="">
        <div class="overlay"></div>
        <div class="work-content">
          <span>Category</span>
          <h3>Lorem ipsum dolor</h3>
          <div class="work-link">
            <a href="#"><i class="fa fa-external-link"></i></a>
            <a class="lightbox" href="{{asset('assets/img/work3.jpg')}}"><i class="fa fa-search"></i></a>
          </div>
        </div>
      </div>
      <!-- /Work -->
      ...
      <!-- Work -->
      <div class="col-md-4 col-xs-6 work">
        <img class="img-responsive" src="{{asset('assets/img/work4.jpg')}}" alt="">
        <div class="overlay"></div>
        <div class="work-content">
          <span>Category</span>
          <h3>Lorem ipsum dolor</h3>
          <div class="work-link">
            <a href="#"><i class="fa fa-external-link"></i></a>
            <a class="lightbox" href="{{asset('assets/img/work4.jpg')}}"><i class="fa fa-search"></i></a>
          </div>
        </div>
      </div>
      <!-- /Work -->
      ...
      <!-- Work -->
      <div class="col-md-4 col-xs-6 work">
        <img class="img-responsive" src="{{asset('assets/img/work5.jpg')}}" alt="">
        <div class="overlay"></div>
        <div class="work-content">
          <span>Category</span>
          <h3>Lorem ipsum dolor</h3>
          <div class="work-link">
            <a href="#"><i class="fa fa-external-link"></i></a>
            <a class="lightbox" href="{{asset('assets/img/work5.jpg')}}"><i class="fa fa-search"></i></a>
          </div>
        </div>
      </div>
      <!-- /Work -->
      ...
      <!-- Work -->
      <div class="col-md-4 col-xs-6 work">
        <img class="img-responsive" src="{{asset('assets/img/work6.jpg')}}" alt="">
        <div class="overlay"></div>
        <div class="work-content">
          <span>Category</span>
          <h3>Lorem ipsum dolor</h3>
          <div class="work-link">
            <a href="#"><i class="fa fa-external-link"></i></a>
            <a class="lightbox" href="{{asset('assets/img/work6.jpg')}}"><i class="fa fa-search"></i></a>
          </div>
        </div>
      </div>
      <!-- /Work -->
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-4">
        <div class="team">
          <div class="team-img">
            <img class="img-responsive" src="{{asset('assets/img/team1.jpg')}}" alt="">
            <div class="overlay">
      ...
      <div class="col-sm-4">
        <div class="team">
          <div class="team-img">
            <img class="img-responsive" src="{{asset('assets/img/team3.jpg')}}" alt="">
            <div class="overlay">
              <div class="team-social">
                <a href="#"><i class="fa fa-facebook"></i></a>
                <a href="#"><i class="fa fa-google-plus"></i></a>
