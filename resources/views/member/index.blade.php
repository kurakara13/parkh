    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card p-30">
                    <div class="media">
                        <div class="media-left meida media-middle">
                            <span><i class="fa fa-check-circle-o f-s-40 color-warning"></i></span>
                        </div>
                        <div class="media-body media-text-right">
                            <h2>1</h2>
                            <p class="m-b-0">Success Order</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card p-30">
                    <div class="media">
                        ...
                        <div class="media-body media-text-right">
                            <h2>5</h2>
                            <p class="m-b-0">Profile Complete</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row bg-white m-l-0 m-r-0 box-shadow ">
            ...
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">Extra Area Capacity</h4>
                        ...
                        <div class="testimonial-widget-one owl-carousel owl-theme">
                            <div class="item">
                                <div class="testimonial-content">
                                    <img class="testimonial-author-img" src="{{asset('assets-member/images/avatar/2.jpg')}}" alt="" />
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <div class="round-img">
                                                <a href=""><img src="{{asset('assets-member/images/avatar/4.jpg')}}" alt=""></a>
                                            </div>
                                        </td>
                                        <td>John Abraham</td>
                ...
                <div class="recent-comment">
                  <div class="media">
                    <div class="media-left">
                      <a href="#"><img alt="..." src="{{asset('assets-member/images/avatar/1.jpg')}}" class="media-object"></a>
                    </div>
